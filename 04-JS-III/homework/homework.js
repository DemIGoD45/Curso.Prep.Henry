...
function dePalabrasAFrase(palabras) {
  ...
  //OBSERVACIONES:
  //Tambien se podria usar el metodo join(' '), asi agregamos el espacio directamente sin necesidad de hacer tantas cosas
  //palabras.join('') 
}
...
function empiezaConNueve(n) {
  ...
  if (num.charAt(0) === "9") { //charAt es como usar num[0]
    return true
  }
